...
try:
    import warp as wp
    WARP_AVAILABLE = True
    # print("✓ NVIDIA Warp available - Real-time acceleration enabled")
except ImportError:
    WARP_AVAILABLE = False
    # print("⚠ NVIDIA Warp not available - Using PyTorch fallback")
...
class WarpAcceleratedWarper:
    ...
    def __init__(self, device: str = "auto", enable_profiling: bool = False):
        ...
        if self.use_warp:
            try:
                ...
                # print(f"  ✓ Warp initialized on device: {self.warp_device}")
        ...
        # print(f"  ✓ PyTorch fallback on: {self.pytorch_device}")
    ...
    def _initialize_warp_kernels(self):
        ...
        # print("  ✓ Custom fabric warping kernels compiled")
    ...
    def warp_image_realtime(self, 
        ...
        if self.use_warp and not force_pytorch:
            try:
                ...
                # print(f"⚠ Warp failed, falling back to PyTorch: {e}")
                pass
    ...
    def clear_cache(self):
        ...
        # print("✓ GPU memory caches cleared")
...
if __name__ == "__main__":
    # print("🚀 NVIDIA Warp Fabric Acceleration Demo")
    # print("=" * 50)
    ...
    # print(f"\n🧪 Testing with {W}x{H} fabric image...")
    ...
    fps = 1.0 / elapsed
    # print(f"✓ Warping completed in {elapsed*1000:.1f}ms ({fps:.1f} fps)")
    # print(f"✓ Real-time capability: {'YES' if fps >= 30 else 'NO'} (30fps threshold)")
    ...
    # print("\n🎉 Warp acceleration setup complete!")
